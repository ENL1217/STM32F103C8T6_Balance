...
float  BST_fCarAngle_P =191.3;//	191.3 //调大小时会左右摆，调大时会振动  请调到基本能够站立 P=91.3是用于给小车在运动过程使用
float  BST_fCarAngle_D =0.21;	// 0.001 0.002 0.004 0.008 0.0010 0.011	 调小时反应慢，调大时会干扰

float  BST_fCarSpeed_P=7.00;
float  BST_fCarSpeed_I=0.100;

const double PID_Original[4] ={191.3, 0.21, 8.00, 0.400}; 
char  alldata[80];
char *iap;
